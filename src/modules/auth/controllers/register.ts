...
export const registerController = async (req: Request, res: Response) => {
  ...
  if (isEmailExists) {
    throw new Shared.Classes.AppError("Email already exists", 400);
  }
  ...
  if (isPhoneNumberExists) {
    throw new Shared.Classes.AppError("Phone number already exists", 400);
  }
  ...
  try {
    ...
    throw new Shared.Classes.AppError("Failed to register user", 500);
  }
};
